...
export interface UserConfig {
    ...
    selected_voice_model_config: number | null;
    // user billing info
    subscription_state: SubscriptionStates;
    subscription_renewal_date: string | null | undefined;
    subscription_enabled_trial_at: string | null | undefined;
    // server settings
    khoj_cloud_subscription_url: string | null | undefined;
