    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('output_modes', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('diagram', 'Diagram')], max_length=200), blank=True, default=list, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_source', models.CharField(choices=[('computer', 'Computer')], default='computer', max_length=30)),
                ('file_type', models.CharField(choices=[('pdf', 'Pdf'), ('plaintext', 'Plaintext'), ('markdown', 'Markdown'), ('conversation', 'Conversation')], default='plaintext', max_length=30)),
