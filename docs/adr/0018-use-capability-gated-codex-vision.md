...
Superseded by ADR 0032, which retains USER-only real-image input while replacing
the standalone Vision Capability term with the single catalog-bound Model Input
Modality contract and deleting the remaining probe/Provider surfaces.
